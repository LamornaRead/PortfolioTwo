                ...
                <div class="port-item">
                    <a href="https://laravel-project.lamorna-read.netmatters-scs.co.uk/" target="_blank">
                        <div class="project-img" style="background-image: url(images/project-card/laravel.png);">
                            <div class="project-info">
                                <p class="info-text">I created a project using Laravel and php. The project is a web app to control and manage company and employee data. I did this using HTML SASS CSS JavaScript PHP Laravel and Tailwind CSS. Login In with <span class="login">admin@admin.com</span> and <span class="login">password</span> as the password.</p>
                            </div>
                        </div>
                        <div class="port-text">
                            <h3 class="pro-heading">Laravel Project</h3>
                            <p class="info-text-two  x-large-hidden">I created a project using Laravel and php. The project is a web app to control and manage company and employee data. I did this using HTML SASS CSS JavaScript PHP Laravel and Tailwind CSS. Login In with <span class="login">admin@admin.com</span> and <span class="login">password</span> as the password.</p>
